...
@onready var BuYantiART = $"."
@onready var Timer_BuYantiART = $"../Timer"
...
func behaviour():
	...
	BuYantiART.play(choosen_behaviour)
	Timer_BuYantiART.wait_time = choosen_wait_time
	print(choosen_wait_time)
	Timer_BuYantiART.start()
