...
func _ready():
	if dialog_manager:
		...
		var story_file = "res://Main-Game/Chapter3/Story-Chapter3/Chapter3e.txt"
		dialog_manager.start_dialog_from_file(story_file)
	else:
		printerr("ERROR: DialogManager belum di-assign!")

func _on_all_dialog_finished():
	get_tree().change_scene_to_file("res://Main-Game/Chapter3/Scene-Chapter3/scenekantor/chapter3f.tscn") #gantiscene
